...
> **Status: Phases 1-5 backend complete.** Schema, scoring engine, backend API,
...
> ready; the UI is generated from [docs/LOVABLE_PROMPT.md](docs/LOVABLE_PROMPT.md). See [CODEMAP.md](CODEMAP.md) for what every file
> does.
...
```bash
.venv/bin/python -m pytest tests/ -q      # 133 tests
```
