...
from app.routers import analytics, calls, chat, evaluations, framework, ingestion, meta
...
async def root():
    return {"name": "CALL-ANALYZER API", "version": "0.7.0", "docs": "/docs"}
